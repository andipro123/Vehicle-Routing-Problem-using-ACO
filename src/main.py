...
from ACO.ant_colony import Solver
...
if __name__ == '__main__':
    ...
    if make_csv:
        ...
        columns_names = [
            'File name', 'Number of Locations', 'Number of trucks', 'Capacity',
            'Optimal', 'Achieved', '2-opt', 'Routes', 'Work time'
        ]
    ...
    for file in tqdm(files):
        ...
        tic = time()
        ant_colony = Solver()
        best_solution, optimal_value, name, n_trucks, capacity = ant_colony(
